@ECHO OFF
REM *************************************************************************
REM * $Id: build-winpc.cmd,v 1.2 2008/01/08 19:13:46 cnepveu Exp $
REM *
...
REM *
REM * Usage:
REM *   build-gw6c [/Release /HAP6-Release /Debug /HAP6-Debug] [/Win32 /x64]
REM *
REM *************************************************************************
...
ECHO.
DEVENV winbuild\winpc\gw6c-config.sln /%COMMAND% "%CONFIGURATION%|%PLATFORM%"
